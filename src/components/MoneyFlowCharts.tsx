...
export function MoneyFlowCharts({
	...
	return (
		<div className="-my-4 896:my-0 896:space-y-4">
			<FlowChartCard
				title={
			...
			<FlowChartCard
				title={
					<div className="space-x-2">
						<BanknoteArrowUp className="mb-1 inline" />
			...
			<FlowChartCard
				title={
					<div className="space-x-2">
						<BanknoteArrowDown className="mb-1 inline" />
...
function FlowChartCard({
	...
	return (
		<Card
			...
			className="896:rounded-3xl 896:border border-b"
		>
