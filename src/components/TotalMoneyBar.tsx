...
export default function TotalMoneyBar() {
	...
	return (
		<div
			id="top"
			className="w-full rounded-b-3xl bg-background p-4 text-center shadow-xl dark:bg-neutral-900"
		>
			{sender ? (
				<>
					<MoneyTransferCard
					...
					{!receivers?.length ? null : (
						<>
							<p className="mt-4 border-t border-dashed pt-4 text-muted-foreground">
								Receivers
							</p>
				...
				<div className="space-y-1">
					...
					<Amount
						className="mx-auto truncate font-bold text-4xl"
						amount={total}
						settings={{ sign: true }}
					/>
				</div>
